...
import frc.robot.base.ActionInstance;
...
public class Robot extends Robot4150<Robot> {
    ...
    @Override
    public List<ActionInstance> getAutoActions() {
        return Arrays.asList(new ActionInstance(() -> driveTrain.setActionQueue(driveTrain.TEST), 7));
    }
}
